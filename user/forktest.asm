...
forktest(void)
{
  ...
  36:	3de50513          	addi	a0,a0,990 # 410 <get_waiting_time+0x8>
  ...
  58:	40c50513          	addi	a0,a0,1036 # 460 <get_waiting_time+0x58>
  ...
  6e:	3b650513          	addi	a0,a0,950 # 420 <get_waiting_time+0x18>
  ...
  80:	3bc50513          	addi	a0,a0,956 # 438 <get_waiting_time+0x30>
  ...
  b0:	3a450513          	addi	a0,a0,932 # 450 <get_waiting_time+0x48>
...
00000000000003f8 <fork_with_priority>:
...
0000000000000408 <get_waiting_time>:
