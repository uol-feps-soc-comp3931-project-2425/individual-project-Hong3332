...
0000000000004b38 <fork_with_priority>:
...
0000000000004b48 <get_waiting_time>:
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f04:	00003797          	auipc	a5,0x3
    4f08:	54c7b783          	ld	a5,1356(a5) # 8450 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    4f9c:	4b853503          	ld	a0,1208(a0) # 8450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    4fc8:	00003917          	auipc	s2,0x3
    4fcc:	48890913          	addi	s2,s2,1160 # 8450 <freep>
  if(p == (char*)-1)
    4fd0:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    4fdc:	0000a797          	auipc	a5,0xa
    4fe0:	c9c78793          	addi	a5,a5,-868 # ec78 <base>
    4fe4:	00003717          	auipc	a4,0x3
    4fe8:	46f73623          	sd	a5,1132(a4) # 8450 <freep>
  ...
  if(p == (char*)-1)
    ...
    504e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5052:	00003717          	auipc	a4,0x3
    5056:	3ea73f23          	sd	a0,1022(a4) # 8450 <freep>
      return (void*)(p + 1);
